...
import 'package:form_app_testing/pages/splash_screen.dart';
import 'package:form_app_testing/pages/widgets/header_widget.dart';
            ...
            children: [
              DrawerHeader(
                ...
                child: Container(
                  ...
                  child: Text("androidmastertopic.blogspot",
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Omran Elsahwy', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                  Text('Android Developer Namtive and Cross Platform', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
                  SizedBox(height: 10,),
                  Container(
                    padding: EdgeInsets.all(10),
                    child: Column(
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("www.omranelshawy@gmail.com"),
                                        ),
                                        ListTile(
